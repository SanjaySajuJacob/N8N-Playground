...
class LmChatOpenRouter {
    ...
    async supplyData(itemIndex) {
        ...
        const model = new openai_1.ChatOpenAI({
            ...
            modelKwargs: (() => {
                    const kw = {};
                    if (options.models) { try { kw.models = JSON.parse(options.models); } catch(e) {} }
                    if (options.responseFormat) { kw.response_format = { type: options.responseFormat }; }
                    return Object.keys(kw).length ? kw : undefined;
                })(),
